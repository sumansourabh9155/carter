...
const ANSWERS = [
  ...
  },
  {
    ...
    citations: [{ label: "Marketing → channels", href: "/reporting" }],
  ...
  },
  {
    ...
    citations: [{ label: "Cloud 7 → breakdown", href: "/products/p2" }, { label: "Reorder data", href: "/products" }],
  ...
  },
  {
    ...
    citations: [{ label: "Supply data", href: "/products" }, { label: "Products", href: "/products" }],
  ...
  },
  {
    ...
    citations: [{ label: "Supply data", href: "/products" }, { label: "Cloud 7", href: "/products/p2" }],
  ...
  },
  {
    ...
    citations: [{ label: "Marketing → Meta", href: "/reporting" }, { label: "Products", href: "/products" }],
  ...
  },
  {
    ...
    citations: [{ label: "Recovery Slides", href: "/products/p6" }, { label: "Reporting", href: "/reporting" }],
  ...
  },
  {
    ...
    bullets: ["Connect a bank + add supplier terms on Products", "Then I'll forecast the actual cash trough and the week it hits"],
    metrics: [{ label: "Cash forecast", value: "Phase 2" }, { label: "Top risk", value: "Cloud 7 stockout" }],
    citations: [{ label: "Connect a bank", href: "/integrations" }, { label: "Add supplier terms", href: "/products" }],
