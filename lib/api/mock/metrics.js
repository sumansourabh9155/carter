...
export function dashboardMetrics(lens = "all") {
  ...
  return {
    ...
    waterfall: [
      { name: "Revenue", value: s.revenue, fill: "#eb6834" },
      { name: "− COGS", value: -s.cogs, fill: "#d6d3d1" },
      { name: "− Ship/Fees/Ret", value: -(s.shipping + s.fees + s.returns), fill: "#d6d3d1" },
      { name: "CM1", value: s.cm1, fill: "#2a78d6", marker: true },
      { name: "− Ad spend", value: -s.adSpend, fill: "#eda100" },
      { name: "CM2", value: s.cm2, fill: "#4a3aa7", marker: true },
      { name: "− Overhead", value: -s.overhead, fill: "#d6d3d1" },
      { name: "CM3", value: s.cm3, fill: "#1baf7a", marker: true },
    ],
    trend: MONTHLY,
