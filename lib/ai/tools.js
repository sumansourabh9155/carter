...
export const TOOLS = [
  ...
  },
  {
    ...
    execute({ productId } = {}) {
      ...
      if (!productId) {
        ...
        return ok(data, [{ label: "Reporting", href: "/reporting" }], FRESH_ADS, "Break-even is 1.0x CM-ROAS — channels below it lose money per dollar.");
      }
      ...
      return ok(
        data,
        [productLink(p), { label: "Reporting", href: "/reporting" }],
        FRESH_ADS,
  ...
  },
  {
    ...
    execute() {
      ...
      return ok(data, [{ label: "Insights", href: "/insights" }, { label: "Products", href: "/products" }], FRESH_CASH);
    },
  },
  {
  ...
  },
  {
    ...
    execute({ channelId, changePct } = {}) {
      ...
      return ok(data, [{ label: "Reporting", href: "/reporting" }], FRESH_ADS);
    },
  },
  {
