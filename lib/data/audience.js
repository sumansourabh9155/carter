...
export const STORE_AUDIENCE = {
  device: {
    label: "Device",
    segments: [
      { id: "mobile", label: "Mobile", color: "#2238b0", spendShare: 0.58, orderShare: 0.46 },
      { id: "desktop", label: "Desktop", color: "#00838f", spendShare: 0.34, orderShare: 0.44 },
      { id: "tablet", label: "Tablet", color: "#7b1fa2", spendShare: 0.08, orderShare: 0.10 },
    ],
  },
  age: {
    label: "Age",
    segments: [
      ...
      { id: "25-34", label: "25–34", color: "#2238b0", spendShare: 0.38, orderShare: 0.42 },
      { id: "35-44", label: "35–44", color: "#00838f", spendShare: 0.22, orderShare: 0.24 },
      { id: "45-54", label: "45–54", color: "#7b1fa2", spendShare: 0.11, orderShare: 0.10 },
      { id: "55+", label: "55+", color: "#2e7d32", spendShare: 0.05, orderShare: 0.05 },
    ],
  },
  geography: {
    label: "Geography",
    segments: [
      { id: "west", label: "US West", color: "#2238b0", spendShare: 0.28, orderShare: 0.30 },
      { id: "northeast", label: "US Northeast", color: "#00838f", spendShare: 0.22, orderShare: 0.24 },
      { id: "south", label: "US South", color: "#e87ba4", spendShare: 0.24, orderShare: 0.20 },
      { id: "midwest", label: "US Midwest", color: "#7b1fa2", spendShare: 0.14, orderShare: 0.14 },
      { id: "canada", label: "Canada", color: "#2238b0", spendShare: 0.07, orderShare: 0.06 },
      { id: "intl", label: "International", color: "#2e7d32", spendShare: 0.05, orderShare: 0.06 },
    ],
  },
};
