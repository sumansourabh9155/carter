...
export const STORE_AUDIENCE = {
  device: {
    ...
    segments: [
      ...
      { id: "desktop", label: "Desktop", color: "#0277bd", spendShare: 0.34, orderShare: 0.44 },
  ...
  age: {
    ...
    segments: [
      ...
      { id: "35-44", label: "35–44", color: "#0277bd", spendShare: 0.22, orderShare: 0.24 },
  ...
  geography: {
    ...
    segments: [
      ...
      { id: "northeast", label: "US Northeast", color: "#0277bd", spendShare: 0.22, orderShare: 0.24 },
