// RAW on-site behavior events, as collected by the Tally Web Pixel
...
export const TRAFFIC_SOURCES = [
  { id: "organic", name: "Organic search", paid: false, sessions: 38000, orders: 1450, color: "#1baf7a" },
  { id: "meta", name: "Meta Ads", paid: true, sessions: 26000, orders: 712, color: "#2a78d6" },
  { id: "direct", name: "Direct", paid: false, sessions: 18500, orders: 820, color: "#78716c" },
  { id: "google", name: "Google Ads", paid: true, sessions: 14800, orders: 534, color: "#eda100" },
  { id: "email", name: "Email", paid: false, sessions: 9800, orders: 610, color: "#4a3aa7" },
  { id: "tiktok", name: "TikTok Ads", paid: true, sessions: 9400, orders: 188, color: "#e87ba4" },
  { id: "snapchat", name: "Snapchat Ads", paid: true, sessions: 6100, orders: 96, color: "#eb6834" },
