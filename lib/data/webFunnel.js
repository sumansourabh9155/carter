...
export const TRAFFIC_SOURCES = [
  { id: "organic", name: "Organic search", paid: false, sessions: 38000, orders: 1450, newOrders: 841, color: "#2e7d32" },
  { id: "meta", name: "Meta Ads", paid: true, sessions: 26000, orders: 712, newOrders: 577, color: "#0277bd" },
  { id: "direct", name: "Direct", paid: false, sessions: 18500, orders: 820, newOrders: 197, color: "#7d929e" },
  { id: "google", name: "Google Ads", paid: true, sessions: 14800, orders: 534, newOrders: 352, color: "#ef6c00" },
  { id: "email", name: "Email", paid: false, sessions: 9800, orders: 610, newOrders: 67, color: "#7b1fa2" },
  { id: "tiktok", name: "TikTok Ads", paid: true, sessions: 9400, orders: 188, newOrders: 165, color: "#e87ba4" },
  { id: "snapchat", name: "Snapchat Ads", paid: true, sessions: 6100, orders: 96, newOrders: 83, color: "#2238b0" },
  { id: "twitter", name: "X (Twitter) Ads", paid: true, sessions: 2400, orders: 54, newOrders: 40, color: "#111827" },
];
