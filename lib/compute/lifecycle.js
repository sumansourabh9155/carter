...
export const LIFECYCLE_META = {
  introduction: { label: "Introduction", desc: "Launched recently — too early for mature benchmarks", color: "#2a78d6" },
  growth: { label: "Growth", desc: "Established and trending up", color: "#1baf7a" },
  ...
  unknown: { label: "Unknown", desc: "No launch date on file", color: "#d6d3d1" },
};
