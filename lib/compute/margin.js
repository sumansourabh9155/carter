...
export const QUADRANT_META = {
  hero: { label: "Hero", desc: "High margin · high velocity", color: "#1baf7a" },
  cashcow: { label: "Cash Cow", desc: "High margin · low velocity", color: "#2a78d6" },
  trafficdriver: { label: "Traffic Driver", desc: "Low margin · high velocity", color: "#eda100" },
