...
function storeInsights(summary, marketing, cash) {
  ...
  if (worst && best) {
    out.push({
      ...
      metric: `${multiple(worst.cmRoas)}`, ref: { label: "Reporting", href: "/reporting" }, impact: worst.spend,
    });
  }
  if (marketing.audienceLeak) {
    ...
    out.push({
      ...
      metric: `${multiple(l.cmRoas)}`, ref: { label: "Reporting", href: "/reporting" }, impact: l.spend * 0.25,
    });
  }
