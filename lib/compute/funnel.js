...
export const FUNNEL_VERDICT_META = {
  ...
  checkoutdrop: { label: "Checkout drop-off", desc: "People want it but abandon at checkout — price shock, shipping cost, or checkout UX", color: "#eda100" },
  healthy: { label: "Healthy", desc: "Converts at or near the catalog average at every stage", color: "#1baf7a" },
};
