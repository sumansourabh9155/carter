...
//
// Only MARGIN counts toward the total. Cards tagged "commitment" (being over
// an ad budget, for instance) are real and rank normally, but the money is
// already spent — adding it to "margin at stake" would mix a cash figure into
// a margin figure and inflate the headline by the size of the plan.
const cappedImpact = (a) =>
  (a.impactKind ?? "margin") === "margin" ? Math.min(Math.abs(a.impact || 0), 50000) : 0;
